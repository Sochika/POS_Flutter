    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        CustomCategoryButton(buttonText: 'categories'.tr,icon: Images.categories,
            isSelected: false,isDrawer: false, padding: width,onTap: ()=> Get.to(const CategoryListViewScreen()),
        ),

        CustomCategoryButton(buttonText: 'sub_categories'.tr,
          icon: Images.categories,isSelected: false,
          padding: width,isDrawer: false, onTap: () => Get.to(const SubCategoryListViewScreen())),

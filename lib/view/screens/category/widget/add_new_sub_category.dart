      ...
      body: GetBuilder<CategoryController>(
          builder: (categoryController) {
            return Column(crossAxisAlignment : CrossAxisAlignment.start, children: [
              ...
              CustomHeader(title: update? 'update_sub_category'.tr : 'add_sub_category'.tr, headerImage: Images.addNewCategory),
              ...
              Padding(
                ...
                child: categoryController.isLoading ? const CustomLoader() :  CustomButton(buttonText: update? 'update'.tr : 'save'.tr,  onPressed: (){

                ...
                GetBuilder<CategoryController>(
                  builder: (categoryController) {
                    ...
                    Row(children: [
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Categories category = categoryController.categoryList[index];
                            return InkWell(
                              onTap: () {
                      ...
                      !categoryController.isCategory? categoryController.categoriesProductList!.isNotEmpty?
                      ...
                      )):const Expanded(child: NoDataScreen()): const Expanded(child: ProductShimmer()),
                    ]) : const NoDataScreen();
                  },
                ),

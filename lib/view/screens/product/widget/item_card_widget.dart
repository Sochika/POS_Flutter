            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 30, child: Text(
                  categoriesProduct!.title!, maxLines: 3,overflow: TextOverflow.ellipsis,
                ...
                Text(PriceConverter.priceWithSymbol(categoriesProduct!.sellingPrice!,),
                  style: fontSizeRegular.copyWith(color: Theme.of(context).primaryColor,decoration: TextDecoration.lineThrough),):const SizedBox(),

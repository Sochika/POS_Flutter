    ...
    return Padding(
      ...
      child: GetBuilder<CouponController>(
          builder: (couponController) {
            return Row(children: [
              Text('${'coupon_title'.tr} : ${coupon!.title}', style: fontSizeRegular.copyWith(fontSize: Dimensions.fontSizeDefault),
                maxLines: 1,overflow: TextOverflow.ellipsis,),
              const SizedBox(width: Dimensions.paddingSizeDefault,),
              Expanded(child: Text('${'coupon_code'.tr} : ${coupon!.couponCode}', style: fontSizeRegular.copyWith(fontSize: Dimensions.fontSizeDefault),
                maxLines: 1,overflow: TextOverflow.ellipsis,))
            ]);
          }
      ),

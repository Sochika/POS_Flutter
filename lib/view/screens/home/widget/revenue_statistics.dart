        ...
        builder: (revenueController) {
          ...
          if(revenueController.revenueModel != null){
            revenue = revenueController.revenueModel!.totalIncome! -
             ...
             itemsAmount = [(revenue.toString()), '${revenueController.revenueModel!.totalIncome}',
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.center,children: [
                ...
                Container(
                  ...
                  child: DropdownButton<String>(
                    value: revenueController.revenueFilterTypeIndex == 0 ? 'overall' : revenueController.revenueFilterTypeIndex == 1 ? 'today' : 'month',
                          ...
                          children: [
                            Positioned(bottom: Dimensions.paddingSizeLarge,left: Dimensions.paddingSizeLarge,
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                Text(PriceConverter.priceWithSymbol(double.parse(itemsAmount[index])),maxLines: 2,overflow: TextOverflow.ellipsis, style: fontSizeBold.copyWith(color: Theme.of(context).cardColor,

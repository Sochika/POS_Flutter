...
import 'package:six_pos/view/base/custom_country_picker_dropdown.dart';
        ...
        return Column(
          children: [
                          ...
                          Container(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                            ...
                            child: DropdownSearch<String>(
                              ...
                              onChanged: (val) {
                                ...
                                splashController.setValueForSelectedTimeZone(val);
                              },
                   ...
                   if(!widget.isBusinessInfo) Padding(
                      ...
                      child: Align(alignment: Alignment.center, child: Stack(children: [
                        ClipRRect(
                          ...
                          child: splashController.shopLogo != null ?  Image.file(File(splashController.shopLogo!.path),
            ...
            Padding(
              ...
              child: CustomButton(buttonText: splashController.isLoading? 'updating......'.tr : 'update'.tr, onPressed: (){

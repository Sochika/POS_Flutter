...
class _AddProductScreenState extends State<AddProductScreen> with TickerProviderStateMixin{
  ...
  Future<void> _loadData() async {
    Get.find<CategoryController>().getCategoryList(1, product: widget.product, reload: true, limit: 100);
    Get.find<BrandController>().getBrandList(1, product: widget.product, reload: true, limit: 100);
    Get.find<UnitController>().getUnitList(1,  product: widget.product, limit: 100);
    Get.find<SupplierController>().getSupplierList(1,  product: widget.product,reload: true, limit: 100);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column( children: [
        CustomHeader(title: update ? 'update_product'.tr : 'add_product'.tr, headerImage: Images.addNewCategory),

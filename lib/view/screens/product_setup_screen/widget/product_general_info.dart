                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Container(
                                ...
                                child: DropdownButton<int>(
                                  ...
                                  items: categoryController.categoryIds.map((int? value) => DropdownMenuItem<int>(
                              ...
                              Container(
                                ...
                                child: DropdownButton<int>(
                                  ...
                                  items: categoryController.subCategoryIds?.map((int? value) {
                                    return DropdownMenuItem<int>(
                                        value: value,
                                        child: Text('${categoryController.subCategoryList?[(categoryController.subCategoryIds!.indexOf(value))].name}'));
                                  }).toList(),
                                  onChanged: (int? value) {

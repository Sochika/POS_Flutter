      ...
      body: GetBuilder<UnitController>(
          builder: (unitController) {
            return Column(crossAxisAlignment : CrossAxisAlignment.start, children: [
              ...
              CustomHeader(title: update? 'update_unit'.tr : 'add_unit'.tr, headerImage: Images.productUnit),
              const SizedBox(height: Dimensions.paddingSizeDefault,),
              ...
              Padding(
                ...
                child: unitController.isLoading ? const CircularProgressIndicator() :  CustomButton(

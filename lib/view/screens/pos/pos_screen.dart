              ...
              SliverToBoxAdapter(child: GetBuilder<CartController>(
                builder: (cartController) {
                  ...
                  return Column(children: [
                    CustomHeader(title: 'billing_section'.tr, headerImage: Images.billingSection),
                                ...
                                Stack(children: [
                                  Column(children: [
                                    CustomButton(
                                      ...
                                      onPressed: ()=> Get.to(()=> const AddNewSuppliersOrCustomer(isCustomer: true)),
                                    ),
                            ...
                            child: Container(
                              ...
                              child: DropdownButton<int>(
                                ...
                                onChanged: (int? value) async {
                                  if(value != null){
                                    cartController.changeOrder(value, payable);
                                  }
                                  cartController.collectedCashController.clear();
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                      ...
                      Padding(
                        ...
                        child: Row(children: [
                          ...
                          SizedBox(width: 120,height: 40,child: CustomButton(
                            buttonText: 'edit_discount'.tr,
                            onPressed:() => showAnimatedDialog(
                              context, ExtraDiscountAndCouponDialog(totalAmount: total),
                      ...
                      PricingWidget(title: 'extra_discount'.tr, amount: PriceConverter.convertPrice(
                          context, PriceConverter.discountCalculation(context,
                        subTotal,

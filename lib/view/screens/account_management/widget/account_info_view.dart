        ...
        children: [
          Row(
            children: [
              ...
              Text(PriceConverter.convertPrice(context, account?.balance), style: fontSizeRegular.copyWith(color: Theme.of(context).primaryColor)),
          ...
          ListTile(
            ...
            title: Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
              child: Column( crossAxisAlignment: CrossAxisAlignment.start,children: [
                ...
                Text('${'balance'.tr} : ${PriceConverter.convertPrice(context, account?.balance)}'),

                Text('${'total_in'.tr}: ${PriceConverter.convertPrice(context, account?.totalIn)}'),

                Text('${'total_out'.tr}: ${PriceConverter.convertPrice(context, account?.totalOut)}'),
              ]),
            ),
            ...
            Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.end, children: [
              Flexible(
                child: Padding(
                  ...
                  child: CustomInkWell(child: Image.asset(Images.editIcon, height: 20), onTap: () {
              ...
              GetBuilder<AccountController>(
                builder: (accountController) {
                  return Flexible(
                    child: CustomInkWell(child: Image.asset(Images.deleteIcon, height: 20), onTap: () {

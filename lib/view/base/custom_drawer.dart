                ...
                SizedBox(width: 80,height: 80, child: ClipRRect(
                  ...
                  child: ClipRRect(
                    ...
                    child: FadeInImage.assetNetwork(
                      ...
                      image: '${configController.baseUrls!.adminImageUrl}/${ configController.profileModel != null ?configController.profileModel!.image??'': ''}',
            ...
            Expanded(
              child: ListView(padding: EdgeInsets.zero, children: [
                ...
                CustomCategoryButton(
                  ...
                  buttonText: 'product_setup'.tr, onTap: ()=> Get.to(()=> const ProductSetupMenuScreen(isFromDrawer: true)),
                ),
                Divider(height: 3, color: Theme.of(context).cardColor),

                CustomCategoryButton(
                  icon: Images.item,
                  buttonText: 'orders'.tr, onTap: ()=> Get.to(()=> const OrderScreen(fromNavBar: false)),
                ),
                Divider(height: 3, color: Theme.of(context).cardColor),

                CustomCategoryButton(
                  icon: Images.accountManagement,
                  buttonText: 'accounts_management'.tr, onTap: ()=> Get.to(()=> const AccountManagementScreen()),
                ),
                Divider(height: 3, color: Theme.of(context).cardColor),

                CustomCategoryButton(
                  icon: Images.profilePlaceHolder,
                  buttonText: 'users'.tr, onTap: ()=> Get.to(()=> const UserScreen()),
                ),
                Divider(height: 3, color: Theme.of(context).cardColor),

                CustomCategoryButton(
                  icon: Images.shopIcon,
                  buttonText: 'shop_settings'.tr, onTap: ()=> Get.to(()=> const ShopSettings()),
                ),
                Divider(height: 3, color: Theme.of(context).cardColor),

                CustomCategoryButton(
                  icon: Images.languageLogo,
                  buttonText: 'change_language'.tr, onTap: ()=> Get.to(()=> const ChooseLanguageScreen()),
                ),

                CustomCategoryButton(
                  icon: Images.logout,
                  buttonText: 'log_out'.tr, onTap: () => showAnimatedDialog(context, const SignOutConfirmationDialog(), isFlip: true)),
